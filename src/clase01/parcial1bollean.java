...
public class parcial1bollean {
	...
	public static void main(String[] args) {
        ...
        final int TARIFA_MOTO_125 = 7000;
        final int TARIFA_MOTO_250 = 10000;
        final  int TARIFA_MAS_250 = 13000;
        ...
        for (int i = 1; i <= n; i++) {
            ...
            else if (tipo.equals("MOTO") && cilindrada <= 125)  base = TARIFA_MOTO_125;
            else if (tipo.equals("MOTO") && cilindrada  <= 250) base = TARIFA_MOTO_250;
            else   base = TARIFA_MAS_250;
